...
from tools.social_checker import SocialChecker
from tools.will_executor import WillExecutor
...
class AgentManager:
    ...
    def _load_config(self) -> Dict[str, Any]:
        return {
            ...
            "selected_tools": [{'name': 'will_executor', 'type': 'reactive', 'file': '/home/dev/Projects/near_hackathon/backend/template/tools/will_executor.py', 'description': 'REACTIVE tool: Executes will by transferring assets', 'module': 'tools.will_executor'}, {'name': 'social_checker', 'type': 'active', 'file': '/home/dev/Projects/near_hackathon/backend/template/tools/social_checker.py', 'description': 'ACTIVE tool: Checks social media login status', 'module': 'tools.social_checker'}]
        }
